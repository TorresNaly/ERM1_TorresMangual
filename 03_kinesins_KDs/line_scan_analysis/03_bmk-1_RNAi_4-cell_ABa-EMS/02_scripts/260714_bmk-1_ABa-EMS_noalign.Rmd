---
title: "260722_bmk1_ABa-EMS_4-cell"
...
write_csv(max_intensities, "bmk-1_L4440_ch2_max_intensities.csv")
```
...
For 2-cell stage, we used the range: -100,1,100

For 4-cell stage, it might make more sense to use -50,1,50 range because the cells are smaller, and the orientation of the membrane can push the ROI quantification box outside of the embryo. 
...
ggsave(file.path(output_dir, paste0(today, "_boxplot_merged.svg")), plot = d,
       width = 12, height = 7)
...
write_csv(stats_wilcox, file.path(output_dir, paste0(today, "_pairwise_wilcoxon_stats.csv")))
